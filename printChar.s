...
loop:
	...
	ldr r2, =remain					// load address into r2
	bl charDraw						// branch link
...
decrement:
	...
	//get int value at +8. r3 == 149
	
	add r3, #8
	ldrb r4, [r3, #8]		//oneth place value 9
	ldrb r5, [r3, #4]		//tenth place value 4
	ldrb r6, [r3, #0]		//hundred place first value 1
	
	strb r4, [r2, #2]		//place oneth place value into r2 + 2
	strb r4, [r2, #1]		//place tenth place value into r2 + 1
	strb r4, [r2, #0]		//place hundreth place value into r2 +0
